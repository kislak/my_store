...
ComfortableMexicanSofa::AccessControl::AdminAuthentication.username = Rails.application.secrets.sofa_user
ComfortableMexicanSofa::AccessControl::AdminAuthentication.password = Rails.application.secrets.sofa_password
